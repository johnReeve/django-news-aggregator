...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pages_newsitem', (
            ...
            ('published_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('submitted_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'pages', ['NewsItem'])


    def backwards(self, orm):
        # Deleting model 'NewsItem'
        db.delete_table(u'pages_newsitem')
    ...
    models = {
        ...
        u'pages.newsitem': {
            ...
            'published_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
